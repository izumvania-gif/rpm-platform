...
// Заголовок вкладки собирается из имени страницы и короткого суффикса
// (фаза 15). До этого у всех 83 страниц был один и тот же длинный заголовок,
// и двенадцать открытых карточек в браузере выглядели как одна. Суффикс
// короткий намеренно: во вкладке видно ~25 символов, и место нужно имени
// записи, а не названию платформы.
export const metadata: Metadata = {
  title: { template: '%s — RPM', default: 'RPM Platform' },
