      ...
      <div className="space-y-2 rounded-md border p-3">
        ...
        {mode === 'existing' ? (
          availablePeople.length === 0 ? (
            // Два разных состояния (фаза 22): справочник пуст — и справочник
            // есть, но все уже в команде. Раньше оба звучали одинаково, и
            // первый продукт получал «все уже в команде» при пустом разделе.
            <p className="text-xs text-muted-foreground">
              {people.length === 0
                ? 'В разделе «Люди» пока никого нет — заведите первого человека во вкладке «Новый человек».'
                : 'Все люди из раздела «Люди» уже в команде этого продукта — можно создать нового.'}
            </p>
          ) : (
            <Select
              aria-label="Человек"
