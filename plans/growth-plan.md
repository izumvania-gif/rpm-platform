...
3. **Фаза D (частично, можно раньше A/B)** — D.1 (инлайн-создание), D.2 (быстрый захват), D.5 (приветственный чек-лист) и части D.3/D.4, не зависящие от Фазы A, улучшают уже работающие 6 модулей уже сейчас — можно вставить перед Фазой A, если хочется быстрого выигрыша по UX без новых моделей данных.
