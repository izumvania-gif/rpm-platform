...
## Что включено в MVP vs что отложено

```mermaid
graph TB
    subgraph "✅ Включено в MVP"
        MVP1[Аутентификация<br/>email + password]
    ...
    style P1_1 fill:#fff9c4
    style P1_2 fill:#fff9c4
    style P1_3 fill:#fff9c4
